...
public class Sound_Pl : MonoBehaviour {

    public AudioClip soundExplosion; //재생할 소리를 변수로 담습니다.
    AudioSource myAudio; //AudioSorce 컴포넌트를 변수로 담습니다.
    public static Sound_Pl instance;  //자기자신을 변수로 담습니다.
    void Awake() //Start보다도 먼저, 객체가 생성될때 호출됩니다
    {
        if (Sound_Pl.instance == null) //incetance가 비어있는지 검사합니다.
        {
            Sound_Pl.instance = this; //자기자신을 담습니다.
        }
    }
    void Start()
    {
