...
public class Slot : MonoBehaviour
{
    ...
    public Stack<Items> slot;       // 슬롯을 스택으로 만든다.
    ...
    public Items ItemReturn() { return slot.Peek(); } // 슬롯에 존재하는 아이템이 뭔지 반환.
    public bool ItemMax(Items item) { return ItemReturn().MaxCount > slot.Count; } // 겹칠수 있는 한계치를 넘으면.   
